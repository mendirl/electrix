...
```sql
COPY
((SELECT * FROM 'consommation-quotidienne-brute-regionale.parquet' WHERE date = '2026-01-31' LIMIT 10)
 UNION ALL
 (SELECT * FROM 'consommation-quotidienne-brute-regionale.parquet' WHERE date = '2013-01-02' LIMIT 10))
TO 'simple.parquet';
```
